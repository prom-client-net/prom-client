...
public class ExtensionsTests
{
    ...
    {
        var metric = Substitute.For<IGauge<long>>();
    ...
    private IMetricFamily<IGauge<long>> MockFamily()
    {
        var metric = Substitute.For<IGauge<long>>();
        var family = Substitute.For<IMetricFamily<IGauge<long>>>();
        family.Unlabelled.Returns(metric);

        return family;
    }

    private IMetricFamily<IGauge<long>, (string, string)> MockFamilyTuple()
    {
        var metric = Substitute.For<IGauge<long>>();
        var family = Substitute.For<IMetricFamily<IGauge<long>, (string, string)>>();
        family.Unlabelled.Returns(metric);
