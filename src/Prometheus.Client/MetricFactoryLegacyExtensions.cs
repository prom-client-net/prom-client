...
namespace Prometheus.Client
{
    public static class IMetricFactoryLegacyExtensions
    {
        ...
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<ICounter> CreateCounter(this IMetricFactory factory, string name, string help, bool includeTimestamp, params string[] labelNames)
        {
        ...
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<ICounter> CreateCounter(this IMetricFactory factory, string name, string help, bool includeTimestamp, bool suppressEmptySamples, params string[] labelNames)
        {
        ...
        /// <param name="includeTimestamp">Include unix timestamp for metric.</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<ICounter<long>> CreateCounterInt64(this IMetricFactory factory, string name, string help, bool includeTimestamp, params string[] labelNames)
        {
        ...
        /// <param name="suppressEmptySamples">Define if empty samples should be included into scrape output</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<ICounter<long>> CreateCounterInt64(this IMetricFactory factory, string name, string help, bool includeTimestamp, bool suppressEmptySamples, params string[] labelNames)
        {
            var options = BuildMetricFlags(includeTimestamp, suppressEmptySamples);
        ...
        /// <param name="includeTimestamp">Include unix timestamp for metric.</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IGauge> CreateGauge(this IMetricFactory factory, string name, string help, bool includeTimestamp, params string[] labelNames)
        {
        ...
        /// <param name="suppressEmptySamples">Define if empty samples should be included into scrape output</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IGauge> CreateGauge(this IMetricFactory factory, string name, string help, bool includeTimestamp, bool suppressEmptySamples, params string[] labelNames)
        {
            var options = BuildMetricFlags(includeTimestamp, suppressEmptySamples);
        ...
        /// <param name="includeTimestamp">Include unix timestamp for metric.</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IGauge<long>> CreateGaugeInt64(this IMetricFactory factory, string name, string help, bool includeTimestamp, params string[] labelNames)
        {
        ...
        /// <param name="suppressEmptySamples">Define if empty samples should be included into scrape output</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IGauge<long>> CreateGaugeInt64(this IMetricFactory factory, string name, string help, bool includeTimestamp, bool suppressEmptySamples, params string[] labelNames)
        {
            var options = BuildMetricFlags(includeTimestamp, suppressEmptySamples);
        ...
        /// <param name="buckets">Buckets.</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IHistogram> CreateHistogram(this IMetricFactory factory, string name, string help, bool includeTimestamp, double[] buckets, params string[] labelNames)
        {
        ...
        /// <param name="buckets">Buckets.</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IHistogram> CreateHistogram(this IMetricFactory factory, string name, string help, bool includeTimestamp, bool suppressEmptySamples, double[] buckets, params string[] labelNames)
        {
            var options = BuildMetricFlags(includeTimestamp, suppressEmptySamples);
        ...
        /// <param name="includeTimestamp">Include unix timestamp for metric.</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IUntyped> CreateUntyped(this IMetricFactory factory, string name, string help, bool includeTimestamp, params string[] labelNames)
        {
        ...
        /// <param name="suppressEmptySamples">Define if empty samples should be included into scrape output</param>
        /// <param name="labelNames">Array of label names.</param>
        public static IMetricFamily<IUntyped> CreateUntyped(this IMetricFactory factory, string name, string help, bool includeTimestamp, bool suppressEmptySamples, params string[] labelNames)
        {
            var options = BuildMetricFlags(includeTimestamp, suppressEmptySamples);
