...
namespace Prometheus.Client
{
    public static class CounterExtensions
    {
        ...
        public static IMetricFamily<ICounter, ValueTuple<string>> CreateCounter(this IMetricFactory factory, string name, string help, string labelName, MetricFlags options = MetricFlags.Default)
        {
