...
namespace Prometheus.Client
{
    ...
    public class Histogram : Collector<Histogram.Child>, IHistogram
    {
        ...
        public class Child : Client.Advanced.Child, IHistogram
        {
            ...
            private Prometheus.Advanced.DataContracts.Histogram _wireMetric;
            ...
            internal override void Init(ICollector parent, LabelValues labelValues)
            {
                ...
                _wireMetric = new Prometheus.Advanced.DataContracts.Histogram();
